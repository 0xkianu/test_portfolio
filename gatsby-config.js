    ...
    projects: [
       {
         ...
         technologies: 'Python, Mistrel 7B LLM, Ollama, Llamaindex, Chroma DB',
         demo: '',
         screen1: '',
         screen2: '',
         screen3: ''
       },
       {
        ...
        github: '',
        technologies: 'Next.js, Postgresql, Prisma (ORM), Clerk (authentication), Uploadcare (file management), Verce',
        demo: '',
        screen1: '',
        screen2: '',
        screen3: ''
